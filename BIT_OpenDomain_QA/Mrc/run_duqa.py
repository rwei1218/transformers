...
# @Author : Mucheng Ren, Ran Wei, Hongyu Liu
# @Email : rdoctmc@gmail.com, weiranbit@163.com, liuhongyu12138@gmail.com 
# @File : run_duqa.py
...
from transformers import (WEIGHTS_NAME, BertConfig,
                                  BertForBaiduQA_Answer_Selection, BertTokenizer,
...
from utils_duqa import (read_baidu_examples, convert_examples_to_features,
                         RawResult, write_predictions, convert_output)
...
def predict(args, model, tokenizer, raw_data):
    predict_examples = read_baidu_examples(raw_data, is_training=False)
